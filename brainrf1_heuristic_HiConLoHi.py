...
IntendedFor = {
    ...
    #   **** sub-C412-specific ****
    # tms visits  
    fmap_run1_ph: [ '{session}/func/sub-{subject}_{session}_task-nback_acq-HiConLoHiWMgated_run-01_bold.nii.gz',
                         '{session}/func/sub-{subject}_{session}_task-rest_acq-gated_bold.nii.gz'],
    fmap_run1_mag:[ '{session}/func/sub-{subject}_{session}_task-nback_acq-HiConLoHiWMgated_run-01_bold.nii.gz',
                         '{session}/func/sub-{subject}_{session}_task-rest_acq-gated_bold.nii.gz'],
    fmap_run2_ph: [ '{session}/func/sub-{subject}_{session}_task-nback_acq-HiConLoHiWMgated_run-02_bold.nii.gz'],
    fmap_run2_mag:[ '{session}/func/sub-{subject}_{session}_task-nback_acq-HiConLoHiWMgated_run-02_bold.nii.gz'],
