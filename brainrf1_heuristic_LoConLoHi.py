#!/usr/bin/env python
"""Heuristic for mapping Brain RF1 scans into BIDS with LoConLoHi stimulation condition visits"""
import os
...
IntendedFor = {
    ...
    # tms visits
    # LoConLoHi    
    fmap_pa_tms_run1: [ '{session}/func/sub-{subject}_{session}_task-nback_acq-LoConLoHiWMgated_run-01_bold.nii.gz',
                     '{session}/func/sub-{subject}_{session}_task-rest_acq-gated_bold.nii.gz'],
    fmap_ap_tms_run1: [ '{session}/func/sub-{subject}_{session}_task-nback_acq-LoConLoHiWMgated_run-01_bold.nii.gz',
                    '{session}/func/sub-{subject}_{session}_task-rest_acq-gated_bold.nii.gz'],
    fmap_pa_tms_run2:[ '{session}/func/sub-{subject}_{session}_task-nback_acq-LoConLoHiWMgated_run-02_bold.nii.gz'],
    fmap_ap_tms_run2:[ '{session}/func/sub-{subject}_{session}_task-nback_acq-LoConLoHiWMgated_run-02_bold.nii.gz'],
    }
'''''
    # task visit
    ...
    fmap_pa_task_run4: [ '{session}/func/sub-{subject}_{session}_task-graphlearning_run-03_bold.nii.gz' ],
    fmap_ap_task_run4: [ '{session}/func/sub-{subject}_{session}_task-graphlearning_run-03_bold.nii.gz' ],
    fmap_pa_task_run5: [ '{session}/func/sub-{subject}_{session}_task-graphlearning_run-04_bold.nii.gz' ],
    fmap_ap_task_run5: [ '{session}/func/sub-{subject}_{session}_task-graphlearning_run-04_bold.nii.gz' ],
    fmap_pa_task_run6: [ '{session}/func/sub-{subject}_{session}_task-graphlearning_run-05_bold.nii.gz' ],
    fmap_ap_task_run6: [ '{session}/func/sub-{subject}_{session}_task-graphlearning_run-05_bold.nii.gz' ],
'''
